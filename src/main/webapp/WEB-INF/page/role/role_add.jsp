...
<body>
			...
			<div class="col-sm-7">
				<div class="form-group">
					...
					<div class="col-sm-9">
						...
						data-rule=角色名称:required; placeholder="请输入角色名称" >
					</div>
				</div>
			</div>
			...
			<div class="col-sm-7">
				<div class="form-group">
					...
					<div class="col-sm-9">
						...
						class="form-control" data-rule=角色描述:required; placeholder="请输入角色描述"></textarea>
					</div>
				</div>
			</div>
		<!-- 添加角色与返回上一级按钮， -->	
	...
	<!-- 
		nice Validator 是一个jQuery智能表单验证

		官网地址：http://www.niceue.com/validator/
