				...
				<ul class="nav ace-nav">
					...
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						class="dropdown-toggle"> <img class="nav-user-photo"
							...
							class="user-info"> <small>欢迎光临: ${user.userName}</small>
				...
				<c:forEach items="${list}" var="menu">
			    	...
			    	<li>
						...
						<c:forEach items="${list}" var="submenu">
                            ...
                            <li>
                            	<a href=" ${submenu.menu_url}" target="mainframe"> 
                            	<i class="icon-double-angle-right"></i> ${submenu.menu_name}
								</a>
							</li>
							</c:if>
						</c:forEach>
